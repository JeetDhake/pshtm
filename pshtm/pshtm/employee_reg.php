            ...
            <div class="wrapper">
                <section class="pst">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $emp_department = $_POST['department_id'];
                        $emp_job_post = $_POST['job_post_id'];
                        ...
                        if ($emp_first_name == '' or $emp_last_name == '' or $emp_department == '' or $emp_job_post == '' or $emp_email == '' or $emp_phone == '' or $emp_image == '') {
                            ...
                            $insert_user = "INSERT INTO employee_records (emp_first_name,emp_last_name,department_id,job_post_id,emp_email,emp_mobile,emp_image,emp_status) VALUES ('$emp_first_name','$emp_last_name','$emp_department','$emp_job_post','$emp_email','$emp_phone','$emp_image','$status')";
